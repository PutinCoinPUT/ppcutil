...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/PutinCoinPUT/ppcutil/coinset)
...
```bash
$ go get -u github.com/PutinCoinPUT/ppcutil/coinset
```
